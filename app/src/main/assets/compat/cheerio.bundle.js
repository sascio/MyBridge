// StreamBridge provider-sandbox bundle: cheerio (browser/slim build).
// Bundled with esbuild from the npm package "cheerio" 1.2.0.
// cheerio is MIT licensed: https://github.com/cheeriojs/cheerio
// Exposes the cheerio API (load/html/text/xml/contains) for
// require('cheerio') and require('cheerio-without-node-native')
// inside the provider sandbox.
...
// cheerio-entry.mjs
var cheerio_entry_exports = {};
__export(cheerio_entry_exports, {
  contains: () => contains,
  default: () => cheerio_entry_default,
  load: () => load,
  merge: () => merge
});
module.exports = __toCommonJS(cheerio_entry_exports);
...
// cheerio-entry.mjs
var cheerio_entry_default = slim_exports;
