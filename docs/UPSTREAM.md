...
|---|---|---|---|---|---|
| NuvioMobile | https://github.com/NuvioMedia/NuvioMobile | `cmp-rewrite` | `465266d7059b3f226b378988393497e8c64a768d` (`chore(store): publish 0.4.16`) | GPL-3.0 | `composeApp/`, `androidApp/`, `iosApp/`, `gradle/` |
...
Previous StreamBridge pin was NuvioMobile `e377942` (0.4.15).
